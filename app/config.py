...
# 分类关键词（用于辅助识别）
CATEGORY_KEYWORDS = {
    "taxi": ["滴滴", "高德", "美团打车", "曹操", "首汽", "出租车", "网约车", "快车", "专车", "打车", "T3出行", "享道出行"],
    "train": ["12306", "火车票", "高铁", "动车", "铁路", "车票", "城际", "复兴号", "和谐号"],
    "flight": ["航空", "机票", "登机牌", "航班", "飞机", "机场", "南航", "东航", "国航", "海航", "春秋航空"],
    "hotel": ["酒店", "宾馆", "住宿", "客房", "民宿", "如家", "汉庭", "全季", "亚朵", "希尔顿", "万豪", "锦江", "7天", "速8", "格林豪泰"],
    "meal": ["餐饮", "餐厅", "饭店", "美团", "饿了么", "外卖", "午餐", "晚餐", "早餐", "正餐", "茶餐厅", "火锅", "烧烤", "快餐"],
    "parking": ["停车", "停车费", "停车场", "P字牌", "泊车费"],
    "fuel": ["加油", "加油站", "中石油", "中石化", "中海油", "壳牌", "汽油", "柴油", "油费"],
    "office": ["办公", "文具", "打印", "复印", "纸张", "硒鼓", "墨盒", "笔记本", "文件夹", "办公用品", "得力", "晨光", "齐心"],
    "telecom": ["电信", "移动", "联通", "话费", "宽带", "流量", "通讯费", "手机费", "网络费"],
    "express": ["快递", "顺丰", "中通", "圆通", "韵达", "申通", "EMS", "邮政", "寄件", "物流"],
    "medical": ["医院", "诊所", "药店", "药房", "医疗", "挂号", "诊疗", "药品", "医药费"],
    "entertainment": ["招待", "KTV", "酒吧", "茶楼", "咖啡馆", "咖啡厅", "茶室", "会所", "娱乐"]
}
